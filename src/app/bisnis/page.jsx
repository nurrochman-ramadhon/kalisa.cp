    ...
    <main>
      <section>
        <div className="relative h-screen">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center w-full">
            ...
            <p className="text-primary3 font-semibold text-md md:text-lg text-center max-w-[850px] px-4 my-4">
              ...
              suatu jaringan bisnis yang menyenangkan dengan berbagai macam
              paket plan yang profitable.
            </p>
        ...
        <p className="text-[14px] text-primary1 text-center w-8/12 mx-auto font-medium">
          ...
          Anda yang dapat disesuiaikan dengan gaya hidup Anda Ketika
          fleksibilitas terbukti memiliki pengaruh positif yang sangat besar
          pada keseimbangan kehidupan kerja, peluang seperti ini bisa menjadi
